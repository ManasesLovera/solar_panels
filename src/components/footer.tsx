      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 justify-between">
            ...
            <div>
              <h3 className="text-lg font-bold mb-4 w-[100px]">Connect</h3>
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/clean.energynow" target="_blank" className="text-gray-400 hover:text-white transition duration-300">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
